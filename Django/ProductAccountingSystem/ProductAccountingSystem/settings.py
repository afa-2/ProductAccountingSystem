...
from .settings_dependencies import *
import os
...
SECURE_SSL_REDIRECT = get_secure_ssl_redirect()
...
ROOT_URLCONF = 'ProductAccountingSystem.urls'
...
WSGI_APPLICATION = 'ProductAccountingSystem.wsgi.application'
